    ...
    <>
      ...
      <section id="Contact">
        ...
        <div className=" py-5 px-5 bg-[#323946]">
          ...
          <div className=" mt-2 px-3 md:ml-96 md:mt-5 md:text-lg text-white opacity-85">
          ...
          <div className=" flex items-center md:justify-between"> 
            <p className=" md:ml-120 md:text-sm copy">
              Copyright ©2026 by Prem Kumar | All Rights Reserved.</p>
            <div className="">
              <a href="#Home"><i className="fa-solid fa-arrow-up
               hover:shadow-[0_0_1rem_#0ef] transition ease-in hover:scale-105 md:mr-8 arrow">
            </i></a>
            </div>
          </div>  
        </div>
